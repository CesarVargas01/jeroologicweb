...
class FormManager {
  ...
  showNotification(message, type = 'info') {
    ...
    notification.className = `notification fixed top-4 left-1/2 transform -translate-x-1/2 z-[999] p-4 rounded-lg shadow-lg max-w-sm transition-all duration-300 opacity-100`;
